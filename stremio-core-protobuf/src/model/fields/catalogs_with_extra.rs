...
impl ToProtobuf<models::catalogs_with_extra::Selected, ()> for Selected {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalogs_with_extra::Selected {
...
impl ToProtobuf<models::CatalogsWithExtra, Ctx> for CatalogsWithExtra {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, ctx: &Ctx) -> models::CatalogsWithExtra {
...
impl ToProtobuf<models::DiscoverDeepLinks, ()> for DiscoverDeepLinks {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::DiscoverDeepLinks {
