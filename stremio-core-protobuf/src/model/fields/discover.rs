...
impl ToProtobuf<models::catalog_with_filters::Selected, ()> for Selected {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::Selected {
...
impl ToProtobuf<models::catalog_with_filters::SelectableType, ()> for SelectableType {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::SelectableType {
...
impl ToProtobuf<models::catalog_with_filters::SelectableCatalog, ()> for SelectableCatalog {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::SelectableCatalog {
...
impl ToProtobuf<models::catalog_with_filters::SelectableExtraOption, ()> for SelectableExtraOption {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::SelectableExtraOption {
...
impl ToProtobuf<models::catalog_with_filters::SelectableExtra, ()> for SelectableExtra {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::SelectableExtra {
...
impl ToProtobuf<models::catalog_with_filters::SelectablePage, ()> for SelectablePage {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::SelectablePage {
...
impl ToProtobuf<models::catalog_with_filters::Selectable, ()> for Selectable {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, _args: &()) -> models::catalog_with_filters::Selectable {
...
impl ToProtobuf<models::CatalogWithFilters, Ctx> for CatalogWithFilters<MetaItemPreview> {
    fn to_protobuf<E: stremio_core::runtime::Env + 'static>(&self, ctx: &Ctx) -> models::CatalogWithFilters {
