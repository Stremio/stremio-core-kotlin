...
{
    fn to_protobuf(&self, _args: &()) -> models::addons_with_filters::Selected {
...
impl ToProtobuf<models::AddonsWithFilters, Ctx> for AddonsWithFilters {
    fn to_protobuf(&self, ctx: &Ctx) -> models::AddonsWithFilters {
                    ...
                    self.installed_addons
                        ...
                        .map(|selected| LoadableAddonCatalog {
                            ...
                            content: Some(models::loadable_addon_catalog::Content::Ready(
                                models::Addons {
                                    items: self.installed_addons.catalog.to_protobuf(ctx),
                                },
                            )),
                        })
                }
